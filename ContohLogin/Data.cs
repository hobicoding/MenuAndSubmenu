...
namespace ContohLogin
{
    public class Data
    {
        ...
        {
            string datasource = "."; //DIISI DENGAN IP SERVER ATAU IS DENGAN TITIK (.) JIKA SERVER ADA DI LOKAL KOMPUTER ANDA.
        ...
        public static DataTable SelecDataTable(string sqlCommand, object[] paramValue)
        {
